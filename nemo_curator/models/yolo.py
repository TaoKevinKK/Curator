...
_YOLOv9_MODEL_ID: Final = "ultralytics/yolov9"
_YOLOv9_MODEL_REVISION: Final = "32bd642"
...
class YOLOv9(ModelInterface):
    """Interface for generating YOLOv9 image embeddings from input images."""
